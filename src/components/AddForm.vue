<template>
    <div>
        ...
        <form v-else class="px-3" @submit.prevent>
            <simple-dropdown
                v-model="record.type"
                :options="references"
                class="border rounded-md border-slate-700 mb-4 focus:bg-slate-800"
            />
            <simple-input
            ...
            <simple-button
                @onclick="createItem"
                class="bg-green-800 hover:bg-green-900 mb-3 rounded-md"
            >
                Create
            </simple-button>
        </form>
